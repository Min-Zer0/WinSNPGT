...
"x86_64-cygwin-threads-multi-3.2.0(0.34053)" or
	die "Errno architecture (x86_64-cygwin-threads-multi-3.2.0(0.34053)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
